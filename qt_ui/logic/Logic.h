...
public:
    ...
    void restoreCompositeState();
    void saveCompositeState();

    void make_composit(std::vector<int> &idx);

    void moveComposit(float dx, float dy, float dz);
    void rotateComposit(float dx, float dy, float dz);
    void scaleComposit(float dx, float dy, float dz);
